...
using ECommerce.Services.AutoMapper.Models;
using System;
...
{
    /// <summary>
    /// Configuration pattern from: https://github.com/NikolayIT/ASP.NET-Core-Template/tree/master/src/Services/AspNetCoreTemplate.Services.Mapping
    /// </summary>
